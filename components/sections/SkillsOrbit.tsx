...
const skills = [
  { label: 'Réseaux & VLAN', angle: 0, color: '#9B87FF' },
  { label: 'Linux / Bash', angle: 60, color: '#3D9EFF' },
  { label: 'Cybersécurité', angle: 120, color: '#34D058' },
  { label: 'PHP / MySQL', angle: 180, color: '#FFB340' },
  { label: 'HTML / CSS / JS', angle: 240, color: '#FF6B85' },
